...
\begin{figure}[H]
% \centering
<<echo=FALSE, fig.width=8, fig.height=6,out.width="2in">>=
 plot(x = 1:10)
@
\end{figure}
% 
...
\begin{figure}[H]
\centering
<<DataVis,echo=FALSE, fig.width=9,fig.height=6,out.width="2in">>=
