...
<<echo=FALSE, fig.cap="Plot1", fig.align="center", fig.width=14, fig.height=4>>=  
...
\end{subfigure}
\begin{subfigure}[b]{\linewidth}
<<echo=FALSE, fig.cap="Plot2", fig.align='center', fig.width=14, fig.height=4>>=  
...
<<Setup-params,include=FALSE,echo=FALSE,results="hide">>=
...
\section{Results}
\label{sec:res}
<<Setup-results, include=FALSE,echo=FALSE,results="hide">>=
