...
combined_plot
@
\caption{Plot of density of hosts in dynamics including both native and invasive host species of Daphnia. The trail A to J represents different buckets in different experiment. The black lines represent the Daphnia dentifera density, the red lines show the Daphnia lumholtzi density, the green lines are the infected Daphnia lumholtzi density, and the blue lines indicate the infected Daphnia dentifera density.}
\end{figure}
